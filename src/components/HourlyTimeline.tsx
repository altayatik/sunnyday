  ...
  return (
    <section className="glass rounded-2xl p-4 sm:p-5">
      <div className="flex items-end justify-between gap-4">
        <div>
          <h2 className="panel-title">12-Hour Sky</h2>
          <p className="subtle mt-1 text-sm">Rain, clouds, UV, and humidity.</p>
        </div>
      </div>
      ...
      <div className="mt-5 flex gap-3 overflow-x-auto pb-2 [scrollbar-width:thin]">
        {summary.hourly.slice(0, 12).map((hour) => (
          <article
            key={hour.time}
            className="min-w-28 rounded-xl border border-white/14 bg-white/12 p-3 text-center"
          ...
          >
            ...
            <WeatherIcon name={hour.conditionIcon} className="mx-auto mt-2 size-6 text-amber-100" />
